...
model = model_zoo.get_config("common/models/mask_rcnn_vitdet_fusion.py").model
...
# train.init_checkpoint = ('/home/lpw/fastssd/lpw/DeFusionv2/experiments/MultiModalFast/models/detectmodelv2.pth')
...
model.roi_heads.box_predictor.fed_loss_num_classes = 4
model.roi_heads.box_predictor.test_score_thresh = 0.02
model.roi_heads.box_predictor.test_topk_per_image = 300
model.roi_heads.box_predictor.use_sigmoid_ce = False
model.roi_heads.box_predictor.use_fed_loss = False
