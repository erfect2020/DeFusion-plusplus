...
from semseg.optimizers import get_layerdecay_optimizer
...
def main(cfg, gpu, save_dir):
    ...
    if os.path.isfile(resume_path):
        ...
        logger.info("load pretrain ckpt")
        checkpoint = './checkpoints/segckpt/CDDFuse.pth'
    ...
    optimizer = get_layerdecay_optimizer(model, lr, optim_cfg['WEIGHT_DECAY'])
