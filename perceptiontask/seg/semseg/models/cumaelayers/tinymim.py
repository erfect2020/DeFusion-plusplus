...
from semseg.models.cumaelayers.vit import PatchEmbed, Block
from semseg.models.cumaelayers.pos_embed import get_2d_sincos_pos_embed
...
class TinyMIMViT(nn.Module):
    ...
    def forward(self, imgs, teacher_out=None):
